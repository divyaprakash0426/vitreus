...
sep "6a. One-shot: CSV → annotated XLSX (Google backend)"
...
sep "6b. One-shot: CSV → CSV with highlights sidecar"
...
sep "6c. One-shot: XLSX input → XLSX output (round-trip)"
...
sep "6d. One-shot: XLSX with specific sheet"
uv run vitreus analyze $xlsx \
...
# ─── 7. VISION ───────────────────────────────────────────────────────────────
sep "7. Vision — image payload (replace path with a real image)"
...
# ─── 8. FULL PIPELINE — Ollama analyze → apply ───────────────────────────────
sep "8. Full pipeline: Ollama → apply"
try {
...
print "  Tip: set \$env.GEMINI_API_KEY = '<key>' before running section 4-6."
print "  Tip: open .xlsx results in LibreOffice Calc to see cell colors."
print "═══════════════════════════════════════════════════════════"
